...
image = Image.open('/home/pi/Downloads/start.bmp')
...
image.save('/home/pi/Downloads/image.jpg')
rotate = Image.open('/home/pi/Downloads/image.jpg')
result = rotate.rotate(90, expand = 1)
result.save('/home/pi/Downloads/result.jpg')
# Affichage et attente 
epd.set_frame_memory(Image.open('/home/pi/Downloads/result.jpg'), 0, 0)
epd.display_frame()
